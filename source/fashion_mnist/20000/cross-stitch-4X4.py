...
def load_data():
    ...
    train_y_1 = train_y_1[0:20000,:]
    train_y_2 = train_y_2[0:20000,:]
    test_X = test_X[0:20000,:]
    test_y_1 = test_y_1[0:20000,:]
    test_y_2 = test_y_2[0:20000,:]
...
def parse_args(argv):
    ...
    parser.add_argument("--n_epoch", type=int, help="number of epoch", default=80)
