...
def main(args):#? where is args from?
	...
	with tf.variable_scope("network"):
		with contrib.framework.arg_scope(
			...
			#(?,8,8,128)->(?,8,8,128)
			conv4_1 = slim.layers.conv2d(conv3_1, 128, kernel_size=[3,3], scope="conv4_1")
			conv4_2 = slim.layers.conv2d(conv3_2, 128, kernel_size=[3,3], scope="conv4_2")
			...
			#(?,8,8,128)->(?,8,8,128)
			conv5_1 = slim.layers.conv2d(conv4_1, 128, kernel_size=[3,3], scope="conv5_1")
			conv5_2 = slim.layers.conv2d(conv4_2, 128, kernel_size=[3,3], scope="conv5_2")
			...
			with tf.variable_scope("fc_6_1"):
				flatten_1 = contrib.layers.flatten(combination21(conv5_1, conv6_3))
				fc_3_1 = contrib.layers.fully_connected(flatten_1,1024)
			with tf.variable_scope("fc_6_2"):
				flatten_2 = contrib.layers.flatten(combination21(conv5_2, conv6_3))
