		...
		with contrib.framework.arg_scope(
			...
			with tf.variable_scope("cross_stitch_1"):
				if cross_stitch_enabled:
					cross_stitch11, cross_stitch12 = apply_cross_stitch(pool1_1, pool1_2)
				else:
					cross_stitch11, cross_stitch12 = pool1_1, pool1_2

			com_result1 = combination21(poo1_1, pool2_1)
			conv2_3 = slim.layers.conv2d(com_result1, 64, kernel_size=[3,3], scope="conv2_3")
			pool2_3 = slim.layers.max_pool2d(conv1_3, kernel_size=[2,2],stride=2,scope="pool2_3")
			...
			with tf.variable_scope("cross_stitch_2"):
				if cross_stitch_enabled:
					cross_stitch21, cross_stitch22 = apply_cross_stitch(pool2_1, pool2_2)
				else:
					cross_stitch21, cross_stitch22 = pool2_1, pool2_2


			com_result2 = combination21(pool2_1, pool2_2, pool2_3)
			...
			with tf.variable_scope("cross_stitch_3"):
				if cross_stitch_enabled:
					cross_stitch31, cross_stitch32 = apply_cross_stitch(conv3_1, conv3_2)
				else:
					cross_stitch31, cross_stitch32 = conv3_1, conv3_2

			com_result3 = combination31(conv3_1, conv3_2, conv3_3)
			...
			with tf.variable_scope("cross_stitch_4"):
				if cross_stitch_enabled:
					cross_stitch41, cross_stitch42 = apply_cross_stitch(conv4_1, conv4_2)
				else:
					cross_stitch41, cross_stitch42 = conv4_1, conv4_2


			com_result4 = combination31(conv4_1, conv4_2, conv4_3)
			conv5_3 = slim.layers.conv2d(com_result4, 128, kernel_size=[3,3], scope="conv5_3")
			...
			with tf.variable_scope("cross_stitch_5"):
				if cross_stitch_enabled:
					cross_stitch51, cross_stitch52 = apply_cross_stitch(conv5_1, conv5_2)
				else:
					cross_stitch51, cross_stitch52 = conv5_1, conv5_2

			com_result5 = combination31(conv5_1, conv5_2, conv5_3)
			conv6_3 = slim.layers.conv2d(com_result5, 128, kernel_size=[3,3], scope="conv6_3")



			with tf.variable_scope("fc_6_1"):
				flatten_1 = contrib.layers.flatten(combination21(cross_stitch51, conv6_3))
				fc_3_1 = contrib.layers.fully_connected(flatten_1,1024)
			with tf.variable_scope("fc_6_2"):
				flatten_2 = contrib.layers.flatten(combination21(cross_stitch52, conv6_3))
